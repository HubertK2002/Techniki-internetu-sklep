...
final class Version20260418163030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_details (product_id INT NOT NULL, promotion_enabled TINYINT DEFAULT 0 NOT NULL, promotion_percent INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, stock INT DEFAULT NULL, PRIMARY KEY (product_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE product_details ADD CONSTRAINT FK_1820CCCF4584665A FOREIGN KEY (product_id) REFERENCES towar (TowId) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
       ...
       // $this->addSql('ALTER TABLE opinion DROP FOREIGN KEY FK_AB02B027A76ED395');
        ...
        //$this->addSql('ALTER TABLE product_details DROP FOREIGN KEY FK_1820CCCF4584665A');
